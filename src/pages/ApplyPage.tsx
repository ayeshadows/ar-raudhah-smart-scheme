          ...
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="space-y-8">
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <button onClick={handleManualEntry} className="w-full bg-card border rounded-xl p-5 flex items-center gap-4 hover:shadow-elevated transition-all text-left">
          ...
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex gap-3 pt-2">
                <Button type="button" variant="outline" onClick={() => setStep("start")} className="h-12 rounded-lg">Back</Button>
